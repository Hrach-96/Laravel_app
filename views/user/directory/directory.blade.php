                                            ...
                                            <div class="form-control-select-wrp">
                                                <select class="form-control pt-0 border-0" name="degree">
                                                    ...
                                                    @foreach(App\DegreeOfTheSchool::where('school_id',$schoolInfo->id)->get() as $degree)
                                                        <option {{ $degrees == $degree->degree->name?'selected':''  }}>{{ $degree->degree->name }}</option>
                                                    @endforeach
                                                </select>
                        ...
                        <div class="row jbpgs-post-start-row more_content">
                            @foreach($users as $user)
                                <div class="col-sm-3 jbpgs-post-start-col">
                                    <div class="jbpgs-post-start-col-wrp bg-white"  style="min-height:420px;box-shadow: 0 0 10px {{ ($user->chooseColor)?$user->chooseColor->category->color:'rgba(0, 0, 0, 0.2)' }};">
                                        ...
                                        <div class="jbpgs-post-start-content p-4">
                                            ...
                                            <h6 class="text-center">
                                                @php
                                                    $survey_answers = App\RegisterSurvey::where('user_id',$user->id)->get();
                                                    if(isset($survey_answers[0])){
