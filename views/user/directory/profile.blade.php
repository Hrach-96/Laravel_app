                                            ...
                                            <div class="col-md-12">
                                                <div class="propg-content-left-tp">
                                                    <div class="propg-usename-row">
                                                        <h3 class="d-inline-block propg-usename mb-3 pointer">
                                                        ...
                                                        @endif
                                                        <span class="propg-location ml-3 pointer"><i class="fa fa-map-marker" aria-hidden="true"></i> {{$user->city}}</span>
                                                        ...
                                                        <span  class="d-inline-block mb-3 pointer"><i class="fa fa-graduation-cap" aria-hidden="true"></i> <span class="span_for_year"> {{$user->GetGraduationYear?$user->GetGraduationYear->year:''}} </span> </span>
