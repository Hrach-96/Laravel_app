                                            ...
                                            <div class="col-md-12">
                                                <div class="propg-content-left-tp">
                                                    <div class="propg-usename-row">
                                                        ...
                                                        <br/>
                                                        <p>
                                                            @if(!empty($title_of_the_post) && $title_of_the_post != '')
                                                                {{$title_of_the_post}}
                                                            @endif
                                                        </p>
                                                        <p>{{ $user->email }}</p>
                                                        ...
                                                        @if(!empty($company_name) && ($what_function_copy && $company_name))
                                                            <div class="propgcl-mr-row-inner-row mb-3 align-top">
                                                                ...
                                                                <div class="d-inline-block align-top"  style="width: 90%">
                                                                    <h6>{{$company_name}}</h6>
                                                                    <p class="mb-0">{{$what_function_copy}}</p>
                                                                    <p class="mb-2">{{$user->GetGraduationYear?$user->GetGraduationYear->year:''}}</p>
                                                                </div>
                                                            </div>
                                                        @endif
                                                        @if(!empty($degree_of_user) && $degree_of_user != '' )
                                                            <div class="propgcl-mr-row-inner-row mb-3 align-top">
                                                                <div class="propgcl-mr-left d-inline-block mr-2"><i class="fa fa-book" aria-hidden="true"></i></div>
                                                                <div class="d-inline-block align-top"  style="width: 90%">
                                                                    <h6>{{$degree_of_user->degree->name}}</h6>
                                                                    @foreach(App\SchoolOfTheUser::where('user_id',$user->id)->get() as $school)
                                                                        <p class="mb-0">{{$school->school->name}}</p>
                                                                    @endforeach
                                                                    <p class="mb-2">{{$user->GetGraduationYear?$user->GetGraduationYear->year:''}}</p>
                                                                </div>
                                                            </div>
    ...
    <div class="modal fade" id="ModalHobby" tabindex="-1" role="dialog" aria-labelledby="ModalForHobby" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form class="form_for_experience" action="{{ route('user.AddHobby') }}" method="post">
    ...
    <div class="modal fade" id="ModalFormation" tabindex="-1" role="dialog" aria-labelledby="ModalForFormation" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form class="form_for_experience" action="{{ route('user.AddFormation') }}" method="post">
                    <div class="modal-body">
                        @csrf
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            @endif
                            <select name="graduation_year" id="graduation_year" class='form-control w-100' required="">
    ...
    <div class="modal fade" id="ModalExperience" tabindex="-1" role="dialog" aria-labelledby="ModalForExperience" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form class="form_for_experience" action="{{ route('user.AddExperience') }}" method="post">
                    <div class="modal-body">
                        @csrf
                        <div class="form-group">
