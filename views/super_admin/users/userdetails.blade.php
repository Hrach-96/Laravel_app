                                ...
                                <div class="col-md-10 offset-1">
                                    <div class="col-md-12 text-center">
                                        @if(!empty($user->avatar))
                                            <img class="img_for_details_page mb-2" src="{{asset("images/avatar/" . $user->avatar)}}">
                                        @else
                                            <img class="img_for_details_page mb-2" src="{{asset("images/avatar/default.jpg")}}">
                                        @endif
                                    </div>
                                    ...
                                    @if ($user->linkedin == 1)
                                        <div class="form-group text-center">
                                            <a href="{{ route('super_admin.linkedin',['id' => $user->id]) }}" target="_blank">
