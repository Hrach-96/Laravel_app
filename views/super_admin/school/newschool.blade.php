		...
		<div class="main-panel p-4">
			<div class="super_admin_content">
				<form action="{{ route('super_admin.NewClient') }}" method="post" class="form" enctype="multipart/form-data">
						...
						<div class="form-group">
							<label for="subdomain_name">Subdomain Name <span class="text-danger">*</span></label>
							@if ($errors->has('subdomain_name'))
								<p role="alert" class='text-danger'><strong>{{ $errors->first('subdomain_name') }}</strong></p>
							@endif
							<input type='text' value="{{old('subdomain_name') }}" name="subdomain_name" id="subdomain_name" class='form-control' required="">
						</div>
