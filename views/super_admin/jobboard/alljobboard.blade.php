	    ...
	    <div class="main-panel p-3">
	        <table class="datatable table table-hover nowrap w-100" >
	            ...
	            <tbody>
	            	@foreach($jobs as $job)
		                <tr>
		                    <td class="row_for_details" data-type="Job" data-id="{{$job->id}}"><p> {{$job->title}}</p> </td>
                            @if($job->chooseSchool)
                                <td class="row_for_details" data-type="Job" data-id="{{$job->id}}"><p>{{$job->chooseSchool->name}}</p></td>
                            @else
                                <td class="row_for_details" data-type="Job" data-id="{{$job->id}}"><p></p></td>
                            @endif
                            <td class="row_for_details" data-type="Job" data-id="{{$job->id}}"><p>{{$job->created_at}}</p></td>
                            <td class="row_for_details" data-type="Job" data-id="{{$job->id}}"><p>{{$job->status==1?'active':'inactive'}}</p></td>
                            <td class="row_for_details" data-type="Job" data-id="{{$job->id}}"><p>{{$job->link}}</p></td>
		                    <td class="row_for_details" data-type="Job" data-id="{{$job->id}}">
