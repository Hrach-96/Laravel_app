                                    ...
                                    <div class="postjobpg-fields-summry-wrp">
                                        ...
                                        <div class="postjobpg-fields-summry-row row">
                                            <div class="col-md-12">
                                                ...
                                                @endif
                                                <div class="postjobpg-fields-grp">
                                                    <input class="form-control" type="text"  value="{{ old('city') }}" placeholder="Enter Your City" name="city" id="city" >
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group  ">
                                            ...
                                            <select name="degree" id="degree" class='form-control' >
                                                ...
                                                @foreach($school->GetSchoolDegree as $degree)
                                                    <option value="{{$degree->degree->id}}">{{$degree->degree->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group">
