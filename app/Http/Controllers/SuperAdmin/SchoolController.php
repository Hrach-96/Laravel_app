...
class SchoolController extends Controller
{
    ...
    public function AddAdminToClient(Request $request){
        ...
        if ($validator->fails()) {
            ...
            $newAdmin->type = User::admin;
            $newAdmin->avatar = 'default.jpg';
            $newAdmin->date_of_import = Carbon::now();
            $newAdmin->save();
            $CategorOfTheUser = new CategoryOfTheUser();
            $CategorOfTheUser->category_id = Category::School_admin;
            $CategorOfTheUser->user_id = $newAdmin->id;
            $CategorOfTheUser->save();
            ...
            $this->mail->ID781694($newAdmin->id);
        }
    ...
    public function AddNewClient(Request $request){
        ...
        if ($validator->fails()) {
            ...
            $school->subdomain_name =  strtolower(request('subdomain_name'));
